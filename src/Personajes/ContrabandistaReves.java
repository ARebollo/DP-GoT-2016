...
*   <b> Curso 15/16 </b>
*/
public class ContrabandistaReves extends Personaje {
	   ...
	   /**
	 	* Constructor parametrizado de la clase Contrabandista
   	 	...
   	 	* 
   	 	*/
        public ContrabandistaReves(String nombre, char marcaId, int turno, int idEstacion, Galaxia gal){
	...
	protected void hallarCamino(Galaxia gal) {
		...
		listaAux= grafoAux.manoIzquierda(gal.getAlto() * gal.getAncho() - gal.getAncho(), gal.getId_salida(), gal.getAncho());
