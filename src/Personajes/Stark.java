...
public class Stark extends Personaje{
	...
	* 
	*/
	 public Stark(String nombre, char marcaId, int turno, int idSala, Mapa map){
	...
	/**
   	 * Metodo para hallar y almacenar el camino que el Stark ha de seguir en el Mapa
   	 * 
   	 * @param map Nuestro Mapa
   	 * 
   	 */
	...
	@Override
	/**
   	 * Metodo para probar una de las LLave recogidas por el Stark en la Puerta del trono
   	 * 
