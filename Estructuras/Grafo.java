	...
	private int siguiente(int origen, int destino){
     ...
     /**
      ...
      private boolean AtajoN(int ancho, int casilla, int tipo){	
    	  ...
    	  // Si esta dentro de la matriz o borde inferior
    	  if ( (tipo == -1 || tipo == 18) && correcto){
   ...
   /**
  	...
  	*/
      private boolean AtajoS(int ancho, int casilla, int tipo){	
    	  ...
    	  // Si esta dentro de la matriz o borde superior
    	  if ( (tipo == -1 || tipo == 12) && correcto){
   ...
   /**
  	...
  	*/
      private boolean AtajoO(int ancho, int casilla, int tipo){	
    	  ...
    	  // Si esta dentro de la matriz o borde der
    	  if ( (tipo == -1 || tipo == 15) && correcto){
   ...
   /**
  	...
  	*/
      private boolean AtajoE(int ancho, int casilla, int tipo){	
    	  ...
    	  // Si esta dentro de la matriz o borde izq
    	  if ( (tipo == -1 || tipo == 21) && correcto){
