    ...
    */
	...
	private int siguiente(int origen, int destino){
     ...
     /**
      ...
      private void tirarParedesAtajo(int ancho, long semilla){	
         ...
         for (int i = 0; i < n; i++){         
        	 ...
        	 if (randomInt - ancho >= 0) // N
        	 {
        		 ...
        		 {
        			 AtajoN(ancho, randomInt);
        		 }	
        	 }
             
             if (randomInt + ancho < getNumNodos()) // S
             {	 
            	 if (floydC[randomInt][randomInt+ancho] > 1) 
            	 {
            		 AtajoS(ancho, randomInt);
            	 }
         	 }
         	
         	 if (randomInt/ancho == (randomInt-1)/ancho && randomInt-1 >= 0) // O
         	 {	 
         		 if (floydC[randomInt][randomInt-1] > 1) 
         		 {
         			 AtajoO(ancho, randomInt);
         		 }
         	 }
             
             if (randomInt/ancho == (randomInt+1)/ancho && randomInt+1 <= getNumNodos()) // E
             {
            	 if (floydC[randomInt][randomInt+1] > 1) 
            	 {
            		 AtajoE(ancho, randomInt);
            	 }
             }
      ...
      private void AtajoN(int ancho, int casilla){	
      ...
      private void AtajoS(int ancho, int casilla){	
      ...
      private void AtajoO(int ancho, int casilla){	
      ...
      private void AtajoE(int ancho, int casilla){	
